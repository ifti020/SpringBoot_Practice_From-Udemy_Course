...
public class DemoSecurityConfig {
    ...
    {
//        return new JdbcUserDetailsManager(dataSource);// ei line ta chilo ekhon refactor korlam
        // refactor as Introduce variable
        JdbcUserDetailsManager jdbcUserDetailsManager = new JdbcUserDetailsManager(dataSource);

        // step 1: define query to retrive a user by user name
        // step 2 : define query to retrive the authritites/roles by userName
        ///////////////////////////////////////////////////////
